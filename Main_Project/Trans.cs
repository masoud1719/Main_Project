...
namespace trans_1
{
    public partial class SinglePhaseTransformer : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            double a = 0.71 * d;
            double b = a;
            // ÏÑÊÑÇäÓ åÇ? ÓÊæä? ˜æ˜ åÓÊå ãÓÊØ?á? ÓÇÏå Èå ˜ÇÑ ã?ÈÑäÏ ÈÇ ÇÝÒÇ?Ô ÇäÏÇÒå ãÑÈÚ? È˜ÇÑ ã?ÈÑäÏ
            ...
            // åÓÊå Óå ÏäÏÇäå
            a = 0.9 * d;
            //b      ÏÑ Ç?äÍÇ æ 4 ÏäÏÇäå Ç? Ç?ä ãÞÏÇÑ  ÇÒ äæÚ ÓÊæä? æ ÒÑå? ÈÏÓÊ ã? Â?äÏ
